...
async def main():
    ...
    from src.bot.handlers import menu, payment, profile, start, workouts

    dp.include_router(start.router)
    dp.include_router(menu.router)
    dp.include_router(profile.router)
    dp.include_router(workouts.router)
    dp.include_router(payment.router)  # Добавлен роутер payment
    ...
    commands = [
        ...
        BotCommand(command="/subscription", description="Подписка"),  # Добавлена
